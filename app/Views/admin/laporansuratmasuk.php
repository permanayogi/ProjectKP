                ...
                <div class="col-12">
                    ...
                    <div class="card" id="report" style="display: none;">
                        <div class="card-header">
                            <form action="/cetaklaporansuratmasuk" method="POST" target="_blank">
                            ...
                            <form action="/cetaklaporandisposisi" method="POST" target="_blank">
                                <input type="hidden" name="startDateDisposisi" id="startDateDisposisi">
                                <input type="hidden" name="endDateDisposisi" id="endDateDisposisi">
                                <button type="submit" class="btn btn-success btn-sm mr-1" style="border-radius: 4px;"><i class="fas fa-print"></i>&nbsp;Disposisi</button>
                            </form>
                        </div>
                        <div class="card-body">
...
<script>
    ...
    function proses() {
        ...
        $('#endDate').val(endDate);
        $('#startDateDisposisi').val(startDate);
        $('#endDateDisposisi').val(endDate);
        if (startDate == "" || endDate == "") {
            ...
            $('#mytable').DataTable({
                ...
                order: [],
                ajax: {
                    url: "<?= base_url('admin/laporansuratmasuk/getTabelLaporan') ?>",
                    type: "POST",
                    data: {
                        'startDate': startDate,
                        'endDate': endDate
