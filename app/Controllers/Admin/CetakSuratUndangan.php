...
class Cetaksuratundangan extends BaseController
{
    ...
    public function cetakSurat()
    {
        ...
        $html = view('admin/suratundangan', $data);
        ...
        $pdf->MultiCell(142, 4, 'Nomor  : ' . $dataSuratKeluar['no_surat'] . '
' . 'Perihal  : Undangan', 0, 'L', 0, 0, '', '', true);
        // $pdf->Cell(185, 2, 'Nomor   :' . $dataSuratKeluar['no_surat'] .
        //     '                                               Kuala Tungkal, ' . $tanggal, 0, 1, 'L');
        // $pdf->Ln(5);
        $pdf->MultiCell(157, 4, 'Kepada Yth. 
' . $dataSuratKeluar['kepada'] . ' 
' . 'Di-   Tempat',  0, 'L', 0, 0, '', '', true);
        $pdf->Ln(3);
        $pdf->SetFont('helvetica', '', 12);
        // $html = '<style>
        // pre {
